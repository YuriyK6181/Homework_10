    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bike_class', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='bike',
                                                 to='veloride.bikeclass', verbose_name='Класс')),
                ('bike_type', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='bike',
                                                to='veloride.biketype', verbose_name='Тип')),
                ('manufacturer', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='bike',
                                                   to='veloride.organization', verbose_name='Производитель')),
            ],
            options={
